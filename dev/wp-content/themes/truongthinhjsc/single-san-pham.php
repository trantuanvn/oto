        ...
        ?>
					...
					<div class="summary-products">
                        <div class="info-products">
                            <h2><?php the_title();?></h2>
    						<h3 class="price">Giá: <?php $price = get_field( "price", $post->ID ); if($price != '') echo $price." VNĐ"; else echo 'Liên hệ'; ?></h3>
    						<ul>
    							<li><label>Mã sản phẩm</label>: U12385</li>
    							<li><label>Nơi sản xuất</label>: <?php $price1 = get_field( "from", $post->ID ); if($price1 != '') echo $price1; else echo 'Việt Nam'; ?></li>
    						</ul>
                        </div>
						<div class="info-buy">
                            ...
                            <div class="phone-contact">
                                <label>Địa chỉ</label>
                                <h5>: 543C Minh Phụng Phường 10 Quận 11</h5>
                            </div>
                        </div>
